...
<div style="width:200px;height:200px;text-align:center" id="loading">
    <img src="images/loader.gif" alt="loading" style="height:64px;width:64px" />
    <br>
    Sending...
</div>
<div style="width:200px;height:200px;text-align:center" id="success">
    <img src="images/success.png" alt="loading" style="height:64px;width:64px" />
    <br>
    Delivery Successful!!!
</div>
<div style="width:200px;height:200px;text-align:center" id="sendError">
    <img src="images/error.png" alt="loading" style="height:64px;width:64px" />
    <br>
    Cannot Deliver!!!
</div>
